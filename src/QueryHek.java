...
public class QueryHek {
   //Result files are stored in this directory
    ...
    static String[] args = new String[] {Constants.JSON_FILE_LOCATION, "/Users/ahmetkucuk/Documents/Developer/java/QueryHEK/QueryHek/sample_input1.txt", "JSON"};

    /**
     * @param args the command line arguments
     *             Event Types: FL, AR, SG, CH
     */
...
//                queryHack(startDate, endDate);
//            }
//        }

//        queryHack("2012-12-01", "2012-12-30");
//        queryHack("2013-12-01", "2013-12-30");
    }

    public static void queryHack(String startDay, String endDay) {
        ...
        if (args.length < 2) {
            ...
            System.out.println("Invalid arguments: Please enter output folder path, followed by input file path and XML or JSON option");
            return;
        }


        m.readFileInfo(m.inputFileName);
        m.readInput(m.inputFileName, startDay, endDay);
        if (m.xmlFlag == 1) {
            m.processHek();
     ...
     */
    public void readInput(String fn, String startDate, String endDate) {
        String strLine = "";
        try {
            // Open the file that is the first
            // command line parameter
