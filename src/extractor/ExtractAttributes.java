...
package src.extractor;

import src.utils.Constants;
import src.domain.EventType;
...
public class ExtractAttributes {
    ...
    public static void main(String[] arg1) {
        ...
        for(EventType e : EventType.values()) {
            String inputDir = String.format(Constants.EX_PATH_TO_RECORDS, e.toString(), "RECORD");
            String outputDir = String.format(Constants.EX_PATH_TO_EXTRACTED_RECORDS, e.toString(), "RECORD");
            String[] args = new String[]{inputDir, Constants.ATTRIBUTES, outputDir, "R"};
            runExtractAttributes(args);
        }


    }

    public static void runExtractAttributes(String[] args) {
...
//                    String variableValue = splitInput[indexOfTokens[i]];
//                    if(variableValue == null || variableValue.equalsIgnoreCase("null") ||
//                            variableValue.equalsIgnoreCase("") ||
//                            variableValue.equalsIgnoreCase("N/A") ||
...
//                if(isValid)
    ...
    public void writeToFile(String fn) {
        ...
        try {
            ...
            int count = 0;
            while (it.hasNext()) {
                String lineToWrite = it.next().toString();
